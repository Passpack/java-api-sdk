...
@Builder
@AllArgsConstructor
public class EncodedStringv2 extends EncodedStringBaseClass implements EncodedString {
    private String iv;
    private String salt;
    private String cipherText;

    public EncodedStringv2(String encodedString, String delimiter) {
        super();
    ...
    public EncodedStringv2(String delimiter, String iv, String salt, String cipherText) {
        super();
        super.delimiter   = delimiter;
        this.iv = iv;
        this.salt = salt;
